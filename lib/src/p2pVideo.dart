...
class _P2PVideoState extends State<P2PVideo> {
  ...
  Future<bool> _waitForGatheringComplete(_) async {
    ...
    print("printing iceGatheringsState");
  ...
  Future<void> _negotiateRemoteConnection() async {
    return _peerConnection!
        ...
        .then((_) async {
          print("iceGatheringComplete. Priinting Local Description");
          ...
          var request = http.Request(
            'POST',
            Uri.parse(
                'http://192.168.0.126:8080/offer'), // CHANGE URL HERE TO LOCAL SERVER
          );
